...
class TeacherListDialog(QDialog):
    ...
    def delete_teacher(self):
        ...
        # Confirm deletion
        msg = create_styled_message_box(self, "Öğretmen Sil", f"'{teacher_name}' öğretmenini silmek istediğinizden emin misiniz?", QMessageBox.Warning)
        ...
        if msg.exec_() == QMessageBox.Yes:
            try:
                ...
                if success:
                    ...
                    msg = create_styled_message_box(self, "Hata", "Öğretmen silinirken bir hata oluştu.", QMessageBox.Critical)
                    msg.exec_()
            except Exception as e:
                msg = create_styled_message_box(self, "Hata", f"Öğretmen silinirken bir hata oluştu: {str(e)}", QMessageBox.Critical)
                msg.exec_()