...
from PyQt5.QtWidgets import QDialog, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QFrame, QComboBox, QMessageBox
...
class SettingsDialog(QDialog):
    ...
    def save_settings(self):
        ...
        if selected_school_type != current_school_type:
            ...
            msg = create_styled_message_box(self, "Başarılı", f"Okul türü {selected_school_type} olarak güncellendi.")
            msg.exec_()
