...
class ClassListDialog(QDialog):
    ...
    def delete_class(self):
        ...
        # Confirm deletion
        msg = create_styled_message_box(self, "Sınıf Sil", f"'{class_name}' sınıfını silmek istediğinizden emin misiniz?", QMessageBox.Warning)
        ...
        if msg.exec_() == QMessageBox.Yes:
            try:
                ...
                if success:
                    ...
                    msg = create_styled_message_box(self, "Hata", "Sınıf silinirken bir hata oluştu.", QMessageBox.Critical)
                    msg.exec_()
            except Exception as e:
                msg = create_styled_message_box(self, "Hata", f"Sınıf silinirken bir hata oluştu: {str(e)}", QMessageBox.Critical)
                msg.exec_()