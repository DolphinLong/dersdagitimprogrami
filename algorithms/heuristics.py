...
class HeuristicManager:
    ...
    def mrv_heuristic(self, variables: List, 
                     domains: Dict, 
                     assignment: Dict) -> any:
        """
    ...
    def degree_heuristic(self, variables: List,
                        constraints: List,
                        assignment: Dict) -> any:
        """
        Degree Heuristic
    ...
    def combined_heuristic(self, variables: List,
                          domains: Dict,
                          constraints: List,
                          assignment: Dict) -> any:
        """
        ...
        mrv_candidates = [v for v in unassigned 
                         if mrv_scores[v] == min_domain_size]
    ...
    def lcv_heuristic(self, variable: any,
                     domain: Set,
                     variables: List,
                     domains: Dict,
                     constraints: List,
    ...
    def fail_first_heuristic(self, variables: List,
                            domains: Dict,
                            constraints: List,
                            assignment: Dict) -> any:
        """
...
class ScheduleHeuristics:
    ...
    def preferred_time_slots(self, lesson_name: str, 
                            time_slots_count: int) -> List[int]:
        """
        ...
        light_lessons = [
            "Beden Eğitimi", "Beden Eğitimi ve Oyun", 
            "Beden Eğitimi ve Spor", "Müzik", "Görsel Sanatlar"
        ]
