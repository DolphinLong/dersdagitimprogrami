...
class HybridApproachScheduler:
    ...
    def __init__(self, db_manager, progress_callback: Optional[Callable] = None):
        ...
        self.ultra_aggressive = UltraAggressiveScheduler(db_manager, progress_callback) if ULTRA_AGGRESSIVE_AVAILABLE else None
    ...
    def _fill_gaps_intelligently(self, schedule: List[Dict], 
                                 coverage_report: Dict) -> int:
        """
    ...
    def _try_fill_slot(self, schedule: List[Dict], 
                      class_id: int, day: int, slot: int) -> bool:
        """
