...
class CSPVariable:
    ...
    def __eq__(self, other):
        return self.class_id == other.class_id and self.lesson_id == other.lesson_id
    ...
    def _revise(
        ...
        for value_i in domain_i:
            ...
            for value_j in domains[var_j]:
                # Test ataması yap
                test_assignment = {var_i: [value_i], var_j: [value_j]}
...
class MaintainedArcConsistency:
    ...
    def maintain_consistency(
        ...
        if related_vars:
            ...
            related_constraints = [c for c in constraints if variable in c.variables]
    ...
    def _get_related_variables(
        self, variable: CSPVariable, variables: List[CSPVariable], constraints: List[CSPConstraint]
    ) -> List[CSPVariable]:
...
class CSPSolver:
    ...
    def solve(
        ...
        assignment = {}
        result = self._backtrack(assignment, variables, domains, constraints, max_backtracks)
    ...
    def _backtrack(
        ...
        ordered_values = self._order_domain_values(var, domains[var], assignment, constraints)
        ...
        for value in ordered_values:
            ...
            new_domains = self.mac.maintain_consistency(var, value, variables, domains, constraints)
