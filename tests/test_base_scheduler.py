...
def test_can_place_lesson_class_conflict(db_manager):
    ...
    # Place first lesson
    scheduler._place_lesson(class_id=1, lesson_id=1, teacher_id=1, day=0, slot=0)
...
def test_can_place_lesson_teacher_conflict(db_manager):
    ...
    can_place, reason = scheduler._can_place_lesson(
        class_id=2, teacher_id=1, day=0, slot=0, check_availability=False
    )
...
def test_find_available_slots(db_manager):
    ...
    slots = scheduler._find_available_slots(class_id=1, teacher_id=1, check_availability=False)
    ...
    new_slots = scheduler._find_available_slots(class_id=1, teacher_id=1, check_availability=False)
...
def test_calculate_coverage(db_manager, sample_schedule_data):
    ...
    # Place some lessons
    for i in range(10):
        scheduler._place_lesson(class_id=1, lesson_id=1, teacher_id=1, day=i % 5, slot=i % 7)
...
def test_can_place_lesson_consecutive_slots(db_manager):
    ...
    can_place, reason = scheduler._can_place_lesson(
        class_id=1, teacher_id=1, day=0, slot=0, check_availability=False, consecutive_slots=2
    )
...
def test_can_place_lesson_consecutive_slots_teacher_conflict(db_manager):
    ...
    can_place, reason = scheduler._can_place_lesson(
        class_id=1, teacher_id=1, day=0, slot=1, check_availability=False, consecutive_slots=3
    )
...
def test_is_placement_valid_advanced_multiple_slots(db_manager):
    ...
    is_valid = scheduler._is_placement_valid_advanced(
        class_id=1, teacher_id=1, day=0, slots=[0, 2, 4], check_availability=False
    )
...
def test_is_placement_valid_advanced_empty_slots(db_manager):
    ...
    is_valid = scheduler._is_placement_valid_advanced(
        class_id=1, teacher_id=1, day=0, slots=[], check_availability=False
    )
