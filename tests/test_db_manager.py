...
from database.models import Class, Classroom, Curriculum, Lesson, Teacher, User
...
class TestScheduleEntryManagement:
    ...
    def test_add_schedule_entry(self, db_manager):
        ...
        # Add schedule entry
        result = db_manager.add_schedule_entry(class_id, teacher_id, lesson_id, classroom_id, 1, 1)
