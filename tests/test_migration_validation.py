...
class TestEdgeCasesAndErrors:
    ...
    def test_single_class_single_lesson_edge_case(self, db_manager):
        ...
        db_manager.add_lesson_weekly_hours(
            lesson_id=lesson_id, grade=5, school_type="Ortaokul", weekly_hours=2
        )
    ...
    def test_maximum_weekly_hours_edge_case(self, db_manager):
        ...
        db_manager.add_lesson_weekly_hours(
            lesson_id=lesson_id, grade=5, school_type="Ortaokul", weekly_hours=40
        )
    ...
    def test_zero_weekly_hours_edge_case(self, db_manager):
        ...
        db_manager.add_lesson_weekly_hours(
            lesson_id=lesson_id, grade=5, school_type="Ortaokul", weekly_hours=0
        )
    ...
    def test_invalid_day_slot_edge_case(self, db_manager):
        ...
        can_place, reason = scheduler._can_place_lesson(
            class_id=1, teacher_id=1, day=-1, slot=0, check_availability=False
        )
        ...
        can_place, reason = scheduler._can_place_lesson(
            class_id=1, teacher_id=1, day=0, slot=-1, check_availability=False
        )
...
class TestExceptionHandling:
    ...
    def test_state_consistency_after_errors(self, db_manager):
        ...
        can_place, reason = scheduler._can_place_lesson(
            class_id=1, teacher_id=3, day=0, slot=0, check_availability=False
        )
...
class TestPerformanceValidation:
    ...
    def test_schedule_generation_completes_in_reasonable_time(
        self, db_manager, sample_schedule_data
    ):
    ...
    def test_conflict_detection_performance(self, db_manager):
        ...
        for i in range(100):
            scheduler._place_lesson(
                class_id=i % 10 + 1, lesson_id=i + 1, teacher_id=i % 5 + 1, day=i % 5, slot=i % 8
            )
