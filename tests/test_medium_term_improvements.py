...
from algorithms.performance_monitor import PerformanceMonitor, get_monitor, timing
...
class TestPerformanceMonitor(unittest.TestCase):
    ...
    def test_timing_decorator(self):
        ...
        self.assertGreater(
            self.monitor.call_counts[f"{test_function.__module__}.{test_function.__name__}"], 0
        )

    def test_record_scheduler_run(self):
        """Test recording scheduler run"""
        self.monitor.record_scheduler_run("TestScheduler", 10.5, 95.0, 100, 0)
